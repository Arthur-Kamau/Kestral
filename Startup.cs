            ...
            app.Run(async (context) =>
                {
                    ...
                    Console.WriteLine($"Body {body}");
                     ...
                     AntlrInputStream inputStream = new AntlrInputStream(body);
StratosLexer lexer = new StratosLexer(inputStream);
    CommonTokenStream commonTokenStream = new CommonTokenStream (lexer);
StratosParser parser= new StratosParser(commonTokenStream);
  ...
  lexer.RemoveErrorListeners ();
        ...
        // }
         ...
         string convertMessagesToJson(List<EditorMessage> messages)
        {
            StringBuilder json = new StringBuilder();
